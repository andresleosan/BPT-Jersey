...
| T104 | Servir registros reales de Regyfit detras de autenticacion admin y ficha completa de alumno | T076,T103 | en-progreso | Backend desplegado (2 callables, import written:249). 2026-09-04: NEXT_PUBLIC_FIREBASE_APP_CHECK_SITE_KEY creada en Cloudflare Pages (bptjersey, production, cifrada) via wrangler; el proximo push de main dispara el build con la variable. Falta verificar en produccion que /admin/members/search carga 249 registros y que el resto de pantallas admin operan con App Check. |
