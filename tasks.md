...
### Pendiente al retomar (2026-09-05, tras T109, T110 y T111)

Sustituye a los checklists anteriores del dia. Arbol limpio tras `50cc3bc` (T109), `7821ecb` (T110) y
el commit de T111. `pnpm verify:mvp` verde en cada corte (ultimo: 245 archivos / 1806 unitarias,
91 Rules, carga 240/240 con p95 39 ms, smoke 5+1) y golden path 10/10 en Emulator con T109 y T110
dentro.

Decisiones que solo puede cerrar el operador:

- [ ] Revisar y aprobar o devolver T097, T098, T109 y T110, en `revision` con evidencia en Emulator.
- [ ] Aprobar T104 y T107, que siguen en `revision`.
...
- [ ] T111 (en `en-progreso`): falta el E2E autenticado en Emulator del ciclo completo de la
      penalizacion (no-show, propuesta, cola de office, cobro con factura enlazada y exencion, mas
      los negativos de rol y Rules). Backend, web y unitarias ya estan cerrados.
