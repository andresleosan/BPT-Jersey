...
| T112 | Mostrar cumpleanos reales en el panel del coach                                                                         | T093,T102                                              | pendiente   | Laguna del DOCX registrada el 2026-09-05 y elevada a fila el 2026-09-05 por instruccion del operador. El panel del coach anuncia cumpleanos sin leerlos del directorio canonico. Debe derivarlos de `dateOfBirth` de los alumnos activos con el alcance minimo por rol y sin exponer la fecha completa a quien no la necesita.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
...
### Pendiente al retomar (2026-09-05, tras cerrar el E2E de T111)

Sustituye a los checklists anteriores del dia. Arbol limpio tras `50cc3bc` (T109), `7821ecb` (T110),
`d7f9b56` (T111 backend/web) y el commit de este E2E. `pnpm verify:mvp` verde (245 archivos / 1806
unitarias, 91 Rules, carga 240/240 con p95 30 ms, smoke 5+1) y golden path 12/12 en Emulator con las
cinco suites, T109, T110 y T111 dentro.

Decisiones que solo puede cerrar el operador:

- [ ] Revisar y aprobar o devolver T097, T098, T109, T110 y T111, las cinco en `revision` con
...
- [ ] T112 a T117 en ese orden. La primera es cumpleanos reales en el panel del coach: hoy
      `apps/web/src/app/coach/page.tsx` los anuncia desde una constante `sampleBirthdays` inventada.
- [ ] T097 restante: comparacion opt-in de adultos (sin modelo de opt-in) y reinicio de la barra de
      progresion al promover (DOCX, no verificado).
