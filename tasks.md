...
| T110 | Cancelar automaticamente la sesion sin quorum y avisar a los reservados                                                 | T096,T062                                              | pendiente   | Laguna del DOCX registrada el 2026-09-05 y elevada a fila el 2026-09-05 por instruccion del operador. Decision 3 del BRIEF: una sesion exige al menos cuatro bookings una hora antes, owner/head coach puede elevar el minimo y, si no se alcanza, una tarea idempotente cancela la sesion y emite avisos in-app. Hoy `evaluateSessionMinimum` calcula `quorumMet` y `cancelSession` cancela a mano, pero nada encadena ambos ni avisa a los reservados.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
...
- [ ] T110, siguiente laguna del orden del ledger. Reconocimiento ya hecho sobre el codigo, con estos
