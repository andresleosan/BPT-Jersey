...
| ID   | Tarea atÃ³mica                                                                       | Depende de     | Estado    | Evidencia de salida                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| ---- | ------------------------------------------------------------------------------------ | -------------- | --------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| T060 | Booking avanzado, listas de espera, creditos y reservas recurrentes                  | -              | revision  | Slice 2026-08-30: oferta manual FIFO, reserva temporal de cupo, aceptacion/declinacion autorizada y booking/auditoria atomicos; 1216/1216 unitarias, 78/78 Rules, Firestore 20/20 y E2E real 6/6. Sin promocion automatica, scheduler, mensajes, creditos, recurrencia, pagos, datos reales, migracion, despliegue ni produccion.                                                                                                                                                                                                                          |
...
| T104 | Servir registros reales de Regyfit detras de autenticacion admin y ficha completa de alumno | T076,T103 | bloqueada | Backend desplegado (2 callables, import written:249, commit 872c398). Web bloqueada hasta configurar NEXT_PUBLIC_FIREBASE_APP_CHECK_SITE_KEY en Cloudflare Pages y cerrar el checklist Pendiente al retomar (T104). |
...
| T107 | Purgar el dataset real de miembros del historial git, del remoto y del arbol de trabajo | T103,T104 | bloqueada | Hallazgo 2026-09-04: apps/web/src/app/admin/real-members-data.ts (243 registros reales, incluidos menores) sigue en el arbol de trabajo sin trackear y en los commits 73cf92b y 872c398 de main/origin. Rompe pnpm lint y pnpm typecheck (apps/web) por error de parseo. Mitigacion aplicada: entrada en .gitignore. Requiere decision del operador: borrar el archivo local, reescribir historial (git filter-repo) con force-push coordinado y re-clonado, y valorar la notificacion de la exposicion conforme a T011. |
