...
| T093 | Conectar alta, listado e importacion administrativa con estudiantes y familias canonicos | T092 | en-progreso | Corte 2026-09-04 aprobado por el operador; continua en-progreso con la matriz RED de T092. 2026-09-04: E2E autenticado en Emulator (Auth+Firestore+Functions) del directorio canonico a nivel de callable, 2/2: alta con contacto de emergencia, replay exacto, busqueda exacta minimizada, detalle restringido, edicion, listado y negativos (sin App Check, sin sesion, kind legacy, lectura directa denegada por Rules). Solo datos sinteticos, sin backfill remoto. |
...
- [ ] Revisar y aprobar o devolver el corte de T093, que es lo que desbloquea T094-T097. La matriz RED ya esta consolidada y sin huecos accionables.
