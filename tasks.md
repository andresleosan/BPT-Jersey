...
| T113 | Aplicar las reglas de stripes por franja de edad del catalogo                                                           | T083,T097                                              | pendiente   | Laguna del DOCX registrada el 2026-09-05 y elevada a fila el 2026-09-05 por instruccion del operador. El catalogo IBJJF distingue stripes por franja de edad y el DOCX fija reglas por edad, pero la propuesta de reconocimiento no las aplica. Belts y stripes siguen sin otorgarse automaticamente: la regla solo debe filtrar candidatos y propuestas.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
...
### Pendiente al retomar (2026-09-05, tras cerrar T111 y T112)

Sustituye a los checklists anteriores del dia. Arbol limpio tras `50cc3bc` (T109), `7821ecb` (T110),
`d7f9b56` (T111 backend/web), `5e8d13e` (E2E de T111) y el commit de T112. `pnpm verify:mvp` verde
(249 archivos / 1850 unitarias, 91 Rules, carga 240/240 con p95 24 ms, smoke 5+1) y golden path 14/14
en Emulator con las seis suites.

Decisiones que solo puede cerrar el operador:

- [ ] Revisar y aprobar o devolver T097, T098, T109, T110, T111 y T112, las seis en `revision` con
      evidencia en Emulator.
- [ ] Aprobar T104 y T107, que siguen en `revision`.
...
- [ ] T113 a T117 en ese orden. La siguiente es las reglas de stripes por franja de edad
      (`T083,T097`): aplicar las franjas del catalogo al proponer stripes.
- [ ] T097 restante: comparacion opt-in de adultos (sin modelo de opt-in) y reinicio de la barra de
      progresion al promover (DOCX, no verificado).
