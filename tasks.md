...
| T057 | Preparar checklist post-piloto de produccion, monitoreo, costos y rollback | T056                                                                  | revision  | PR #2 permanece como draft sobre `56d278f`; CI #49 y el preview de Pages finalizaron exitosamente sin produccion. El merge a `main` sigue bloqueado porque el autodeploy de Pages no coordina Functions/Rules; T011, staging, costos/alertas, CD protegido y T058 siguen abiertos.                          |
