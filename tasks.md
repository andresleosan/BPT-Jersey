...
| T105 | Publicar la tienda del club: showcase en landing, catalogo y pedidos de recogida para clientes y gestion administrativa        | T016,T021                                              | revision    | Dominio `@bpt-jersey/domain/shop`, callables `listShopCatalog`/`saveShopProduct`/`placeShopOrder`/`updateShopOrder` y afines, `/shop`, `/admin/shop`, seccion `#shop` en landing con imagenes reales de bptjersey.com. Sin checkout online: pago en academia. Sin despliegue.        |
| T106 | Integrar el Waiver and Emergency Contact Form en el alta administrativa                                                     | T090,T093,T011                                         | pendiente   | Analisis y propuesta en `docs/operations/t106-waiver-enrolment-integration-analysis.md`: contacto de emergencia/direccion en el alta, firma presencial atestiguada por admin y renovacion digital; bloqueado para produccion por T011 y texto legal aprobado.                              |
