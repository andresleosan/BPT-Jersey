...
| T010 | Seleccionar proveedor de pagos disponible en Jersey para post-piloto                   | -          | bloqueada | Paquete sintï¿½tico de decisiï¿½n creado en docs/operations/payment-provider-decision-packet.md: tres candidatos ficticios, lï¿½mites de checkout/webhooks, modelo de costos y alertas; T010 permanece bloqueada hasta verificar disponibilidad real en Jersey, tï¿½rminos, cotizaciï¿½n y aprobaciï¿½n explï¿½cita |
| T011 | Confirmar politica de retencion, residencia y borrado con asesoria aplicable a Jersey | - | bloqueada | Paquete de decision preparado; falta aprobacion del operador y asesor aplicable para plazos, regiones, transferencias, borrado, backups y restauracion. No hay politica legal aprobada.
...
| ID   | Tarea atÃ³mica                                                         | Depende de     | Estado    | Evidencia de salida                                                                                                                                                                                                                                                                                                                                              |
| ---- | --------------------------------------------------------------------- | -------------- | --------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| T043 | Implementar pipeline CRM, owner, next action y tareas post-piloto     | T021,T025      | revision | Contratos de dominio, store in-memory/Firestore y callables CRM implementados; headCoach queda limitado a sus leads; UI usa preview sintetico por defecto y callable opt-in; pruebas focalizadas 10/10, typecheck Functions/Web y regresion completa 159 archivos/1082 pruebas pasan; verify:mvp y validacion sin PII/secretos pasan; Rules cliente siguen default-deny y no hay datos reales, despliegue ni aprobacion productiva. |
| T044 | Implementar timeline CRM automatico post-piloto                       | T019,T043      | revision | Persistencia de timeline, idempotencia por eventKey, parser de eventos y callable de lectura implementados; duplicado conflictivo falla cerrado; pruebas focalizadas 10/10, typecheck Functions/Web y regresion completa 159 archivos/1082 pruebas pasan; verify:mvp pasa; UI y datos reales no activados, sin migracion ni despliegue productivo. |
...
| T046 | Implementar email/SMS e historial externo de entrega post-piloto      | T045           | revisiÃ³n  | Frontera provider-independent, historial tenant-scoped, fallback seguro y contract tests registrados abajo                                                                                                                                                                                                                                                       |
...
| T055 | Ejecutar carga, contratos, seguridad, accesibilidad y E2E completo por rol | T008,T009,T011,T018,T019,T021-T033,T037-T042,T045,T047-T054,T083,T086 | revision | Gates locales completos: verify:mvp, unitarias 159/1082, Rules 64/64, carga sintetica 240 solicitudes/concurrencia 24 sin fallos (p95 82 ms) y E2E smoke 5 pasan/1 omitida. T055 queda en revision para el piloto sintetico; T011, carga live/staging y produccion siguen bloqueados. |
| T056 | Ejecutar piloto con datos controlados y corregir hallazgos | T055 | revision | Piloto E2E sintetico ejecutado: 71 pasaron, 14 omitidos por live/staging u opt-in y 0 fallos; verify:mvp y carga sintetica pasan; borrador de acta en docs/operations/t056-pilot-operator-acta-draft.md; falta firma del operador y validaciones live/staging.
| T057 | Preparar checklist post-piloto de produccion, monitoreo, costos y rollback | T056 | revision | Checklist operativo actualizado en `docs/operations/t057-post-pilot-production-checklist.md`; incorpora verify:mvp 159/1082, Rules 64/64, carga sintetica p95 82 ms, runtime 2/2, seguridad y rollback local; firma T056, T011, staging real, costos/alertas y autorizacion productiva siguen pendientes. |
...
- Estado: T046 pasa a revisiÃ³n; no es aprobaciÃ³n de producciÃ³n ni habilita envÃ­o real.
...
- Se separaron dependencias de implementaciÃ³n tÃ©cnica de los gates operativos/productivos: T008 y T009 conservan decisiones configurables, T011 conserva el gate de datos reales, T080 conserva T054 como gate de cualquier apply y T055 queda `bloqueada` hasta cerrar sus dependencias reales.
...
- Estado: T043/T044 permanecen en `revision` hasta revisión humana y validaciones de integración autorizadas; no bloquean T056.
...
### Evidencia T034 - Adaptador provider-independent sintético - 2026-08-26
...
- Verificacion: pruebas focalizadas 6/6, typecheck de dominio/Functions, test de runtime desplegable 2/2 y `verify:mvp` 159/159 archivos, 1082/1082 tests, Rules 64/64, carga 240/240 (p95 82 ms) y E2E 5 passed/1 skipped pasan; no se agrego esquema Firestore ni migracion.
- Costos y limites: costo comprometido USD 0/mes mientras el proveedor permanece `unconfigured`; T010 sigue bloqueada hasta evidencia real de Jersey, terminos, alertas y aprobacion explicita.
- Estado: T034 pasa a `revision`; T035/T036 permanecen pendientes y no se habilita pago real.