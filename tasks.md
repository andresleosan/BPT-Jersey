...
| T097 | Conectar progreso personal, promociones revisadas y reportes al participante canonico | T039,T040,T041,T042,T047,T048,T049,T050,T051,T052,T093 | pendiente | 2026-09-05: la pagina de progreso de la cuenta deja de mostrar competidores y tecnicas sinteticos y conecta el progreso propio real (`getStudentProgressSummary`), sin comparacion (solo adultos opt-in, inexistente en el piloto). Condicion de entrada detectada: ningun escritor crea la cabecera `studentLevelProgress/{studentId}`, por lo que todo alumno queda `uninitialized`, `listRecognitionCandidates` lo excluye y `approvePromotion` no puede operar. Decision del operador 2026-09-05 (opcion A): el head coach abre el nivel inicial con un callable auditado, sin stripes automaticos; implementacion en curso. |
