...
| T115 | Limitar a 25 caracteres la etiqueta de condiciones de salud                                                             | T035,T093                                              | pendiente   | Laguna del DOCX registrada el 2026-09-05 y elevada a fila el 2026-09-05 por instruccion del operador. El formulario oficial usa una etiqueta corta de 25 caracteres para la condicion mostrada al staff, separada de la nota clinica completa. Hoy no existe ese limite ni la separacion entre etiqueta y detalle.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
...
### Pendiente al retomar (2026-09-05, tras cerrar T111, T112, T113 y T114)

Sustituye a los checklists anteriores del dia. Arbol limpio tras `50cc3bc` (T109), `7821ecb` (T110),
`d7f9b56` (T111 backend/web), `5e8d13e` (E2E de T111), `2961e8e` (T112), `4a3b997` (T113) y el commit
de T114. `pnpm verify:mvp` verde y golden path 15/15 en Emulator con las siete suites.

Decisiones que solo puede cerrar el operador:

- [ ] Revisar y aprobar o devolver T097, T098, T109, T110, T111, T112, T113 y T114, las ocho en
      `revision` con evidencia en Emulator.
- [ ] Aprobar T104 y T107, que siguen en `revision`.
...
- [ ] T115 a T117 en ese orden. La siguiente separa la etiqueta corta de 25 caracteres de la nota
      clinica completa en el contrato de salud.
- [ ] T097 restante: comparacion opt-in de adultos (sin modelo de opt-in) y reinicio de la barra de
      progresion al promover (DOCX, no verificado).
