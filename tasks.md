...
| T114 | Publicar la interfaz preclase del coach con sugerencias de asistentes                                                   | T096,T066                                              | pendiente   | Laguna del DOCX registrada el 2026-09-05 y elevada a fila el 2026-09-05 por instruccion del operador. El DOCX describe una vista previa a la clase con los asistentes probables para acelerar el check-in. Hoy solo existe `getSessionOperationalView` con los reservados confirmados.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
### Pendiente al retomar (2026-09-05, tras cerrar T111, T112 y T113)

Sustituye a los checklists anteriores del dia. Arbol limpio tras `50cc3bc` (T109), `7821ecb` (T110),
`d7f9b56` (T111 backend/web), `5e8d13e` (E2E de T111), `2961e8e` (T112) y el commit de T113.
`pnpm verify:mvp` verde (250 archivos / 1869 unitarias, 91 Rules, carga 240/240, smoke 5+1) y golden
path 15/15 en Emulator con las siete suites.

Decisiones que solo puede cerrar el operador:

- [ ] Revisar y aprobar o devolver T097, T098, T109, T110, T111, T112 y T113, las siete en `revision`
      con evidencia en Emulator.
- [ ] Aprobar T104 y T107, que siguen en `revision`.
...
- [ ] T114 a T117 en ese orden. La siguiente es la vista preclase del coach con los asistentes
      probables de la sesion (`T096,T102`), derivada de reservas y asistencia canonicas.
- [ ] T097 restante: comparacion opt-in de adultos (sin modelo de opt-in) y reinicio de la barra de
      progresion al promover (DOCX, no verificado).
