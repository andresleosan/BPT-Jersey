...
| T107 | Purgar el dataset real de miembros del historial git, del remoto y del arbol de trabajo | T103,T104 | en-progreso | 2026-09-04: archivo local borrado; historial de main reescrito y verificado en un clon fresco con git filter-repo (0 referencias al blob en 87 commits). El force-push a origin y el borrado del deployment de Pages 95d8b4d3 fueron bloqueados por el clasificador del asistente y quedan para el operador (comandos en la evidencia). Despues: purga de objetos colgantes en GitHub, borrar el bundle de respaldo y valorar la notificacion conforme a T011. |
