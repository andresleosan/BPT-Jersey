...
| Medida                                                                                                                                                                                                                          | Valor   |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------- |
| Cloud Functions exportadas por `apps/functions/src/index.ts` (en esa medición la herramienta descartaba cinco re-exports que no se declaran con `onCall`/`onSchedule`: tres helpers de auth, `bootstrapEmulatorOwner` y `provisionAdminRole`; `provisionAdminRole` pasó a ser función el 2026-09-09 y los cuatro re-exports de helpers se quitaron de `index.ts` el 2026-09-25, así que hoy no descarta ninguno) | 165     |
