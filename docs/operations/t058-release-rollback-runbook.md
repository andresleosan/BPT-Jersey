...
| ----------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `consents/consent-callables` (4)                                                                                  | `acceptWaiver`, `getWaiverEvidenceDownload`, `getWaiverRegistration`, `revokeWaiverConsent`                                                                                    | **`BPT_SYNTHETIC_PILOT`**: fallan cerrado fuera del piloto, y hoy no hay ninguna forma de que esa variable llegue a producción (§3.2). Además exigen R2 real (`R2_ACCOUNT_ID`, `R2_BUCKET_NAME` y los dos secretos `R2_*`, placeholders desde T104) y una versión publicada del waiver (T011, texto legal)                                                                                                                                                                                                                                                                             |
...
| `families` (3), `profiles/*` (4)                                                                                  | familia, perfil de cliente y de tutor                                                                                                                                          | Sin gate de código. Camino de onboarding de T094; el perfil autoservicio hoy no llega al directorio canónico (T121 lo sustituye)                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
...
| ------------------------------------------------------------------------------------------------------------------------------------------- | --------- | ----------------------------------------------------------------------------- | ------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `BPT_SYNTHETIC_PILOT`                                                                                                                       | Functions | consentimientos, salud, documentos privados, export agregado                  | no definido: esos callables fallan cerrado | Decisión de T058: sustituir el gate por uno de producción real, o un `.env.bptjersey-f5a25` que el artefacto copie, o `defineString`. Nunca `true` a ciegas                 |
