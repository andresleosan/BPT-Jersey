...
| Seguridad                         | T089 deniega el ID productivo desde argumento/entorno/Firebase config antes de I/O y mantiene staging sin allowlist fail-closed. Focales 23/23; verify:mvp 175/1237 unitarias, Rules 78/78, carga 240/240 (p95 29 ms), smoke 5/5 + 1 omitida esperada; secret scan acotado limpio; audit 0 high/critical y 2 moderadas transitivas preexistentes                                              | Verificado localmente; produccion bloqueada |
...
| Staging real                      | Descartado por decision del operador el 2026-09-07 (enmienda al final de docs/operations/t057-synthetic-staging-contract.md): no se crea proyecto separado. Sustituido por el Emulator como gate funcional (T099: Rules 92/92 y golden path 19/19 sobre `51918ad`) y por el runbook de release y rollback de T058; los seis riesgos que el Emulator no cubre pasan a T058 como riesgo asumido | Sustituido 2026-09-07                       |
...
- Procedimiento completo, inventario de produccion y baseline reconstruible: `docs/operations/t058-release-rollback-runbook.md` (entregable de T099, 2026-09-07).
...
T089 queda aprobada tecnicamente el 2026-08-31 tras pruebas focales, gate global y revision de seguridad verdes.
La evidencia historica conserva que 10 documentos Regyfit se importaron en
