...
test.describe("public homepage @smoke", () => {
  test("presents the BPT Jersey academy and platform across viewports", async ({
    ...
    // Since T050V2 every "Book a free class" goes to the enrolment page, not the contact anchor.
    const contactCta = page.locator("#contact").getByRole("link", { name: "Book a free class" });
