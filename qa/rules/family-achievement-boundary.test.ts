...
const projectId = "demo-bpt-jersey-family-achievement-boundary";
...
describe("family achievement direct Firestore boundary", () => {
  for (const actor of actors) {
    it("denies every family achievement path operation for '" + actor.name + "'", async () => {
      const context =
        actor.uid === null
