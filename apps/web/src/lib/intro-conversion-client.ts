...
const contextSchema = z.strictObject({
  ...
  instructions: z.strictObject({ accountName: z.string(), sortCode: z.string(), accountNumber: z.string(), bankName: z.string().nullable(), referenceHint: z.string() }).nullable(),
});
...
export async function submitIntroMembershipApplication(input: { requestId: string; conversionId: string | null; studentId: string; site: "Town" | "West"; planId: (typeof planIds)[number]; proofId: string | null; bankReference: string | null }) {
