...
Sin subagentes especializados, lo que hace que Cronos actúe como un desarrollador full-stack de calidad —en vez de producir la app genérica que cualquier modelo produce por defecto— es el buen uso de las skills. Esta es la pieza que reemplaza directamente a los 10 `titanes/*.template.md` que existían hasta v2.0.1: cada skill de abajo concentra la disciplina y el checklist que antes vivía en la plantilla de un Titán específico.
