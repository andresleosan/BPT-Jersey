...
const adminItems = [
  ...
  task(
    ...
    "desplegada",
    "Ejercida de verdad en producción el 2026-09-10: HTTP 200 y el evento de auditoría escrito. No levanta la limitación de D5: sigue sin haber un segundo owner.",
    "-",
  ...
  task(
    ...
    [REF_TASKS, "apps/functions/src/schedule", "apps/web/src/app/admin/classes"],
    "funcion",
  ),
  task(
    "T034V2",
...
const TASK_SURFACES = {
  ...
  T033V2: ["apps/functions/src/schedule", "apps/web/src/app/admin/classes"],
