...
const RESOLUTION_REQUIREMENTS = {
  ...
  T058: [
    "Crear primero las cinco alertas del runbook 6.1 con los umbrales ya escritos alli, y despues dar la autorizacion explicita para esta release nombrando las 31 callables del primer lote: es la precondicion 4.0(1) del runbook y el propio runbook dice que 'ya se probo antes' no la sustituye. Es lo unico que falta del lado del codigo.",
