...
const RESOLUTION_REQUIREMENTS = {
  ...
  T109: [
    "Declarar coordenadas y radio de 50 m por sede como configuracion, sin guardar coordenadas de personas.",
    "Anadir la senal de proximidad al contrato de check-in y al registro de asistencia como senal, no como prueba.",
    "Exigir motivo y auditoria cuando el staff aplica override porque la senal falta o queda fuera del radio.",
    "Declarar en la evidencia que el auto check-in del alumno sigue cerrado por el contrato de T028.",
  ],
  T110: [
    "Encadenar el calculo de quorum con la cancelacion de la sesion en una tarea idempotente.",
    "Emitir avisos in-app a los reservados usando el productor auditado de T062, sin email ni SMS.",
  ...
  T111: [
    ...
    "Vincular la penalizacion resuelta con la facturacion manual de T095 sin proveedor externo.",
    "Probar en Emulator el no-show que genera cargo, la exencion medica que no y el replay idempotente.",
  ],
  T112: [
...
const recoveryItems = [
  ...
  task(
    ...
    "T028,T096",
    "Alta 2026-09-05 por instruccion del operador sobre las lagunas del DOCX. Decision 5 del BRIEF: senal de elegibilidad, nunca prueba, sin guardar coordenadas y con override de staff con motivo y auditoria. Hoy no existe ninguna senal de proximidad en el contrato de check-in ni en el registro de asistencia, y ninguna sede declara coordenadas ni radio. El auto check-in del alumno sigue cerrado por T028.",
    [
      "tasks.md",
      "BRIEF.md",
  ...
  task(
    ...
    "T096,T062",
    "Alta 2026-09-05 por instruccion del operador sobre las lagunas del DOCX. Decision 3 del BRIEF: minimo de cuatro bookings una hora antes, minimo elevable por owner o head coach y tarea idempotente que cancela y avisa. Hoy evaluateSessionMinimum calcula quorumMet y cancelSession cancela a mano, sin nada que los encadene ni avise.",
    [
      "tasks.md",
      "BRIEF.md",
  ...
  task(
    ...
    "T095,T096",
    "Alta 2026-09-05 por instruccion del operador sobre las lagunas del DOCX. Decision 2 del BRIEF: no-show de Town genera penalizacion manual auditable de GBP 15 con resolucion por office. Hoy reconcileSessionNoShows marca el no-show pero no existe cargo, cola de resolucion ni vinculo con la facturacion manual.",
    [
      "tasks.md",
      "BRIEF.md",
      "apps/functions/src/schedule/schedule-service.ts",
      "apps/functions/src/finance",
    ],
    "special",
  ),
  task(
  ...
  task(
    ...
    "T083,T097",
    "Alta 2026-09-05 por instruccion del operador sobre las lagunas del DOCX. El catalogo IBJJF distingue stripes por franja de edad y el DOCX fija reglas por edad, pero la propuesta de reconocimiento no las aplica. Belts y stripes siguen sin otorgarse automaticamente.",
    ["tasks.md", "packages/domain/src/levels", "apps/functions/src/levels/level-service.ts"],
    "special",
  ),
  task(
    "T114",
    ...
    "T096,T066",
    "Alta 2026-09-05 por instruccion del operador sobre las lagunas del DOCX. El DOCX describe una vista preclase para acelerar el check-in; hoy solo existe getSessionOperationalView con los reservados confirmados.",
    [
      "tasks.md",
      "apps/web/src/app/coach/page.tsx",
      "apps/functions/src/schedule/schedule-service.ts",
  ...
  task(
    ...
    "T019,T093",
    "Alta 2026-09-05 por instruccion del operador sobre las lagunas del DOCX. El DOCX permite que administracion conceda permisos adicionales a un coach. Hoy el rol es fijo en el claim y no existe concesion revocable ni auditada.",
  ...
  task(
    ...
    "T090,T106",
    "Alta 2026-09-05 por instruccion del operador sobre las lagunas del DOCX. Ademas del waiver principal, el DOCX contempla disclaimers gestionables con aceptacion registrada. Hoy solo existe el waiver versionado de T090 y el texto legal sigue bloqueado por T011.",
