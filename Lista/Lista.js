...
const RESOLUTION_REQUIREMENTS = {
  ...
  T108: [
    ...
    "SIGUIENTE, rebanada 10: el ejecutor forward, y despues los otros cinco. Van dos ejecutores de siete.",
    ...
    "Completar el documento de operacion padre: existe desde la rebanada 7 con frozen -> applying, y le faltan applying -> verified y verified -> completed, cada una transaccion propia con su prueba. Mas el plan privado congelado con su dry-run y la cuarentena.",
