...
const RESOLUTION_REQUIREMENTS = {
  ...
  T108: [
    ...
    "DECISION PENDIENTE DEL OPERADOR: donde vive el artefacto encriptado del plan privado y con que llave. R2 esta cableado de punta a punta desde el 2026-09-08 y es el candidato obvio, pero residencia, llave y retencion T011 durante la ventana de rollback son decision, no implementacion. Hasta que se tome, los dos puertos siguen sin adaptador y el ensayo de punta a punta no puede correr.",
