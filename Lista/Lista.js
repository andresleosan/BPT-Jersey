...
const attendanceItems = [
  ...
  task(
    ...
    "T022,T029",
    "Contratos y parsers de checkout 64/64, 3 métodos (authorizedAdult, independentRelease, staffOverride con notas), store con validación de asistencia previa e idempotencia 13/13, callables RBAC 11/11, client 10/10, suite completa 840/840 en 105 archivos; eventos de auditoría registrados.",
    ["tasks.md", "BRIEF.md"],
    "mvp",
  ),
  task(
