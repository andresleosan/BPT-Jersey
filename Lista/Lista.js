...
const RESOLUTION_REQUIREMENTS = {
  ...
  T108: [
    ...
    "SIGUIENTE: el dry-run que produce el manifiesto -clasificar cada fila legada con cero escrituras y emitir el recibo-, y despues el runner del forward que enlace ejecutor, plan congelado y verificacion del paso 4 contra la linea base de bootstrap.",
