...
const IMPLEMENTATION_OVERRIDES = {
  ...
  T019: {
    ...
    implementationEvidence:
      "Audit events administrativos e importaciones probados; el audit log completo del MVP sigue pendiente.",
  },
  T020: {
    implementationStatus: "verificada",
    implementationEvidence:
  ...
  T021: {
    implementationStatus: "parcial",
    implementationEvidence:
      "Miembros y paneles reales/preview implementados; las relaciones completas del MVP siguen pendientes.",
  },
  T024: {
    implementationStatus: "parcial",
    implementationEvidence:
...
const identityItems = [
  ...
  task(
    "T018",
    "Implementar registros versionados de consentimiento y aceptación",
    "pendiente",
    "Registrar versiones de consentimiento, aceptación y revocación.",
    "T013,T016",
    "El flujo de consentimiento todavía está pendiente.",
    ["tasks.md", "BRIEF.md"],
    "mvp",
  ),
  task(
    ...
    "T012,T013,T016",
    "P1 reabre el audit log completo; eventos administrativos e importaciones existentes conservan cobertura parcial.",
    ["tasks.md", "BRIEF.md"],
    "mvp",
  ),
];
...
const peopleItems = [
  ...
  task(
    ...
    "T021",
    "Los flujos de relaciones familiares todavía están pendientes.",
    ["tasks.md", "BRIEF.md"],
    "mvp",
  ),
  task(
...
const attendanceItems = [
  ...
  task(
    ...
    "T022,T027",
    "Los métodos de registro de llegada todavía están pendientes.",
    ["tasks.md", "BRIEF.md"],
    "mvp",
  ),
  task(
    ...
    "T019,T028",
    "El flujo de corrección de asistencia todavía está pendiente.",
    ["tasks.md", "BRIEF.md"],
    "mvp",
  ),
  task(
...
const membershipItems = [
  task(
    ...
    "pendiente",
    "Definir planes, reglas de acceso y límites semanales.",
    "T013",
    "El catálogo de membresías todavía está pendiente.",
    ["tasks.md", "BRIEF.md"],
    "mvp",
  ),
  task(
    ...
    "pendiente",
    "Admitir transiciones de prueba, activa, pausada, vencida y cancelada.",
    "T032",
    "El ciclo de vida de la membresía todavía está pendiente.",
    ["tasks.md", "BRIEF.md"],
    "mvp",
  ),
  task(
  ...
  task(
    ...
    "pendiente",
    "Admitir registros financieros operativos y conciliación.",
    "T019,T033",
  ...
  task(
    ...
    "T037",
    "El acceso y la deuda PAYG todavía están pendientes, sin proveedor externo.",
    ["tasks.md", "BRIEF.md"],
    "mvp",
  ),
];
...
const progressItems = [
  task(
    ...
    "T009,T021,T025",
    "Las reglas de evaluación siguen dependiendo de T009.",
    ["tasks.md", "BRIEF.md"],
    "mvp",
  ),
  task(
    ...
    "pendiente",
    "Resumir el progreso del estudiante sin promoción automática.",
    "T039",
    "El resumen de progreso todavía está pendiente.",
    ["tasks.md", "BRIEF.md"],
    "mvp",
  ),
  task(
    ...
    "pendiente",
    "Calcular rachas y candidatos con pesos explícitos y ausencias médicas.",
    "T029,T039",
  ...
  task(
    ...
    "pendiente",
    "Mantener las decisiones de reconocimiento bajo revisión humana autorizada.",
    "T015,T041",
...
const specialItems = [
  ...
  task(
    "T083",
    "Relevar Levels: JIU-JITSU - IBJJF y recrear la sección Levels",
    "pendiente",
    "Inspeccionar read-only cada belt, stripe/nivel y característica observable en Regyfit, y recrear la capacidad por rol en BPT Jersey.",
    "T072,T084",
    "Discovery, inventario y diseño aprobados; ejecución programada en P5 después de identidad y tatami.",
    ["tasks.md", "BRIEF.md"],
    "special",
  ),
  task(
