...
const attendanceItems = [
  ...
  task(
    ...
    "T029,T030",
    "Proyección pura agregada 65/65, store unificado sin estado duplicado 14/14, callable RBAC 12/12, client 11/11, suite completa 844/844 en 105 archivos; consistencia y quórum en vivo verificados.",
    ["tasks.md", "STACK.md"],
    "mvp",
  ),
];
