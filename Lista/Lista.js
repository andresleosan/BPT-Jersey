...
const RESOLUTION_REQUIREMENTS = {
  ...
  T108: [
    ...
    "SIGUIENTE: el runner del forward -lectura del plan privado, verificacion del paso 4 contra la linea base de bootstrap, y las transacciones de verificacion y cutover- o directamente el plan privado congelado con su dry-run, que es quien trae el almacen real detras del puerto de artefacto de la rebanada 9, hoy el unico puerto sin adaptador.",
