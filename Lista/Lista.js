...
const specialItems = [
  ...
  task(
    ...
    "T075,T084",
    "Guarda fail-closed verificada: bptjersey-f5a25 se deniega por argumento/entorno/Firebase config antes de I/O y staging queda cerrado sin allowlist. Focales 23/23; verify:mvp 1220/1220, Rules 78/78, carga 240/240 y smoke 5/5 + 1 omitida; audit 0 high/critical y secret scan acotado limpio. Sin red, datos reales, migracion ni despliegue.",
    [
      "tasks.md",
      "STACK.md",
