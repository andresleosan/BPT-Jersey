...
const RESOLUTION_REQUIREMENTS = {
  T127: [
    ...
    "Aportar credenciales R2 reales para la evidencia PDF. Precision del 2026-09-08: los secretos R2_ACCESS_KEY_ID y R2_SECRET_ACCESS_KEY ya existen en Secret Manager, con version 1 habilitada del 2026-09-04 -la misma fecha de las versiones 1 de los tres MEMBER_DIRECTORY_*, que eran placeholders sustituidos por material real el 09-07-, asi que lo que falta casi con seguridad no es crear los secretos sino anadirles una version 2. Sugerir no es saber: el 4.0(5) prohibe versions access porque imprimiria el valor, y la lista no distingue un placeholder de una credencial buena, asi que solo el operador puede confirmarlo. Compartido con T058.",
