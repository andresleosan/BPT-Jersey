...
const IMPLEMENTATION_OVERRIDES = {
  ...
  T023: {
    implementationStatus: "verificada",
    implementationEvidence:
      "Implementación técnica verificada para el piloto sintético: unitarias 133 archivos/976 pruebas, Rules 4/4, integración Firestore Emulator 1/1, UI guardian/administrativa, typecheck, lint y formato; T023 permanece en revisión y producción bloqueada por T011/T018.",
  },
  T032: {
    implementationStatus: "verificada",
    implementationEvidence:
  ...
  T024: {
    implementationStatus: "revisión",
    implementationEvidence:
      "Adaptador piloto verificado: unitarias 133 archivos/979 pruebas, focalizadas T024 20/20, integración Firestore Emulator con R2 sintético 1/1, Rules directas 4/4, typecheck, lint y formato; T024 permanece en revisión y el cierre productivo depende de T011/T018.",
  },
  T025: {
    implementationStatus: "verificada",
    implementationEvidence:
  ...
  T055: {
    ...
    implementationEvidence:
      "QA revalidado: suite unitaria 147/1036, Rules 8/64, E2E 67/67 con 14 live/staging omitidos, integración Firestore/R2 sintética 1/1, typecheck/lint/format/diff limpios y baseline de roster 1.000/500/250; carga live/staging y T018 siguen pendientes.",
  },
  T082: {
    implementationStatus: "verificada",
    implementationEvidence:
...
const peopleItems = [
  ...
  task(
    ...
    "T021,T011",
    "Implementación técnica completada y verificada para el piloto sintético; T023 permanece en revisión del operador y producción sigue bloqueada por T011/T018 y BPT_SYNTHETIC_PILOT.",
  ...
  task(
    ...
    "T016,T021,T023",
    "Adaptador piloto de PDF privado verificado con callables, hash, permisos, expiración, revocación, relaciones guardian vigentes y datos sintéticos; T024 permanece en revisión y el cierre productivo depende de T011/T018.",
...
const closeoutItems = [
  ...
  task(
    ...
    "T019,T051,T052",
    "CSV agregado T051/T052 owner/admin, piloto sintético fail-closed, journal y auditoría atómicos, rate limit persistente y sin PII/IDs ni archivo server-side; gates completos y producción bloqueada por T011/T018.",
    ["tasks.md", "BRIEF.md"],
    "mvp",
  ),
  task(
    ...
    "T013,T024",
    "Contrato fail-closed, checksum/conteos, rehearsal Emulator apply→rollback y runbook verificados; revalidado 2026-08-24: unitarias 6/6, Firestore Emulator 1/1, E2E 2/2; producción bloqueada por T011/T018.",
    ["tasks.md", "STACK.md"],
    "mvp",
  ),
  task(
    ...
    "T018,T019,T021-T033,T037-T042,T045,T047-T054,T083,T086",
    "Pruebas unitarias, Rules, integración y E2E sintético documentadas; el 2026-08-24 pasaron unitarias 147/147 (1036/1036), Rules 8/8 (64/64), typecheck, lint, formato, build web y E2E sintético 67/67, con 14 escenarios live/staging omitidos; faltan carga completa, validaciones live/staging y decisiones bloqueadas del MVP.",
    ["tasks.md", "STACK.md"],
    "mvp",
  ),
  task(
    ...
    "T055",
    "Paquete de preparación listo en docs/operations/t056-pilot-readiness-packet.md; E2E completo 67 pasados, 14 omitidos y 0 fallos; falta aprobar el acta y resolver los gates restantes.",
    ["tasks.md", "BRIEF.md"],
    "mvp",
  ),
  task(
