...
const roadmapV2Items = [
  task(
    ...
    "-",
    "T060 en revision: waitlist persistida tenant-scoped con join/list/cancel, posicion atomica, membership active/trial vigente, student-scope/RBAC, Rules y E2E real 5/5. Gate global 1155/1155 unitarias y 78/78 Rules; sin WIP activo. Produccion, App Check/rate limit, promociones/ofertas, aceptacion, reordenamiento, UI final, creditos, recurrencia, cobros y mensajes siguen fuera.",
    [
      "tasks.md",
      "BRIEF.md",
