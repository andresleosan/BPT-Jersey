...
const RESOLUTION_REQUIREMENTS = {
  ...
  T108: [
    ...
    "SIGUIENTE, rebanada 13: el dry-run que produce el manifiesto -clasificar cada fila legada con cero escrituras y emitir el recibo-. Es lo unico que falta para cerrar el circulo: el ejecutor sabe consumir un manifiesto y el almacen sabe guardarlo, pero nadie lo fabrica todavia. Despues, el runner del forward que enlace ejecutor, plan congelado y verificacion del paso 4 contra la linea base de bootstrap.",
