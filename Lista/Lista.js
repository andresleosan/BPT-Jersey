...
const RESOLUTION_REQUIREMENTS = {
  ...
  T058: [
    ...
    "PENDIENTE del operador tras la rotacion: revocar el token viejo en Cloudflare, y confirmar en el panel que el token nuevo quedo acotado solo al bucket bptjersey -se pidio asi, pero la pantalla mostraba 'apply to all buckets' y no quedo confirmado-. Desde el repositorio no se puede leer: la credencial OAuth local no tiene permiso de gestion de tokens.",
