...
const RESOLUTION_REQUIREMENTS = {
  ...
  T058: [
    "Verificacion en navegador del 4.4.4: abrir con sesion real en https://bptjersey.pages.dev -no en una preview, por CORS- las pantallas de staff, familias, CRM, penalizaciones y anuncios, y anotar 200 o errores de consola. Es lo unico que queda para poder aprobar la fila: la release del 2026-09-08 esta desplegada y verificada por sondeo y por logs, pero 'responde 401' no es 'las pantallas funcionan'.",
    "Dejar constancia del aviso a office y coaches. La release del 2026-09-08 se hizo con esa casilla vacia, y el 8 del runbook dice que una casilla vacia es una release que no se hizo como dice el runbook.",
    "Crear la quinta alerta del 6.1, fallos de Cloud Scheduler, en cuanto el job emita su primera metrica: hasta entonces la API responde 404 porque el descriptor no existe. La politica ya esta escrita; las otras cuatro se crearon el 2026-09-08.",
    ...
    "Lotes siguientes: consentimientos, salud y export siguen fuera mientras BPT_SYNTHETIC_PILOT no se lleve a produccion, y todo lo que ligue R2 mientras sus dos secretos sigan en version 1. Volver a medir el delta antes de cada lote.",
  ],
  T059: [
