...
const RESOLUTION_REQUIREMENTS = {
  ...
  T058: [
    ...
    "PENDIENTE: rotar la access key de R2. Su valor acabo en el transcript por la notificacion de cambio de fichero del IDE. Exige redespliegue, porque las funciones fijan la version del secreto en vez de usar latest.",
