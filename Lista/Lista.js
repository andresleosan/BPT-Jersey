...
const roadmapV2Items = [
  task(
    ...
    "-",
    "T060 en revision: autoservicio minimo autenticado para adulto/tutor con seleccion por nombre, posicion, cancelacion confirmada y bloqueo de reapertura; 23/23 focales, E2E real 5/5 sin retries mas 1/1 final, verify:mvp 172/1166, Rules 78/78, carga 240/240 y smoke 5/1. Sin staff UI, promociones/ofertas, aceptacion, reordenamiento, creditos, recurrencia, booking automatico, cobros, mensajes, datos reales, migracion, despliegue ni produccion.",
    [
      "tasks.md",
      "BRIEF.md",
      ...
      "qa/tests/waitlist-self-service-auth-emulator.spec.ts",
  ...
  task(
    ...
    "-",
    "Bandeja interna persistida en revision: store tenant-scoped/idempotente, callable read-only owner/administrator con proyeccion minimizada, acceso directo denegado, UI responsive y evidencia focalizada 15/15 + 8/8 + Emulator 1/1 + Rules 71/71 + E2E 2/2 sintetico y 2/2 real. Sin productor automatico, auditoria persistida, App Check, rate limit por actor, CRM externo, mensajes, datos reales, credenciales, gasto, migracion ni despliegue; produccion sigue bloqueada por T011/T057.",
    [
      "tasks.md",
      "BRIEF.md",
  ...
  task(
    ...
    "-",
    "Slice T063 restrictivo en revision: resolver guardian valida tenant, contacto principal, menor activo y relacion vigente; falla cerrado para no relacionado, secundario, futura, expirada, inactiva o reloj invalido. Unitarias 23/23, Firestore Emulator 2/2, Rules 64/64, E2E responsive 2/2 y estabilidad 10/10; verify:mvp pasa con 1122 unitarias, carga 240/240 y smoke 5 aprobadas/1 omitida. Sin migraciones, datos reales, credenciales, cobros ni gasto; tutor secundario y checkout adulto siguen pendientes y denegados.",
    [
      "tasks.md",
      "BRIEF.md",
