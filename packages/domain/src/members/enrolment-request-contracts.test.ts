...
describe("enrolment plan preferences", () => {
  ...
  it("filters sites, retired and administrative plans, and the exact 12th and 16th birthdays", () => {
    ...
    expect(ids("2010-09-07", "West")).toEqual(["west-teens", "west-teens-payg"]);
    expect(ids("2010-09-06", "West")).toEqual(["payg", "bpt-jersey-adult", "west-adult"]);
    expect(ids("2008-09-07", "Town")).toEqual(["bpt-jersey-adult", "town-adult"]);
